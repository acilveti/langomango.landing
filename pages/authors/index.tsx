...
import Cta, {CtaAuthors} from 'views/HomePage/Cta';
    ...
    <>
      ...
      <HomepageWrapper>
        <WhiteBackgroundContainer>
          <HeroAuthors />
          {/* <Partners /> */}
          <BasicSection1 imageUrl="/multiplatform.jpeg" title="Get paid for your work" overTitle="a new channel to monetize your work">
            <p>
              Fair and generous retribution to authors, for reading of the ebooks inside the app, and for refering our app to their follower and fans.
            </p>
            <ul>
              <li>10$ per refered user that subscribes to langomango</li>
              <li>We share the 50% of the income generated by users subscriptions with authors when the users read your ebooks</li>
            </ul>
          </BasicSection1>
        </WhiteBackgroundContainer>
