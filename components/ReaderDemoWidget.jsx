...
export default function ReaderDemoWidget({ selectedLanguage, onInteraction }) {
  ...
  // Handle interactions - either use provided callback or default newsletter modal
  ...
  }, [pageChangeCount, setIsModalOpened, onInteraction]);
